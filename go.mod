...
replace github.com/blocktree/go-owcdrivers v1.2.0 => github.com/blocktree/go-owcdrivers v1.0.12

replace github.com/blocktree/go-owcrypt v1.1.1 => github.com/blocktree/go-owcrypt v1.0.1
